...
const DashboardWrapper = ({ handleTheme,children }) => {
    ...
    return (
        <div className="body_wrapper">
            <HeaderAndDrawer setTogleSideBar={setTogleSideBar} togleSideBar={togleSideBar} handleMobNav={handleMobNav} handleTheme={handleTheme}/>
